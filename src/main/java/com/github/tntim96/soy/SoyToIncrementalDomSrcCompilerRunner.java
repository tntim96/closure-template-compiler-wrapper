 ...
 */
public final class SoyToIncrementalDomSrcCompilerRunner {

  public static void main(String[] args) {
    try {
      compileSoy(args, System.err);
    } catch (Exception e) {
      throw new RuntimeException("Failed to run SoyToIncrementalDomSrcCompiler", e);
    }
  }
  ...
  public static void compileSoy(String[] args, PrintStream err) throws Exception {
    ...
    // 1. Load the class
    Class<?> clazz = Class.forName("com.google.template.soy.SoyToIncrementalDomSrcCompiler");
