...
/**
 * Main entry point for the SoyParseInfoGenerator tool.
 *
 * <p>This class is used to run the SoyParseInfoGenerator from the command line or programmatically.
 ...
 */
public final class SoyParseInfoGeneratorRunner {

  public static void main(String[] args) {
    try {
      compileSoy(args, System.err);
    } catch (Exception e) {
      throw new RuntimeException("Failed to run SoyParseInfoGenerator", e);
    }
  }
  ...
  public static void compileSoy(String[] args, PrintStream err) throws Exception {
    ...
    // 1. Load the class
    Class<?> clazz = Class.forName("com.google.template.soy.SoyParseInfoGenerator");
